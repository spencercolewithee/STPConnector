...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2019-06-04T10:29:31.230-04:00[America/New_York]")public class MyselfItem {
  /**
  ...
  public enum KeyEnum {
    ...
    ISUNLICENSEDALLOWEDTOREPLY("isUnlicensedAllowedToReply"),
    PERMISSIONS("permissions"),
    ISLDAPUSERNOTBOUNDTOACCOUNT("isLdapUserNotBoundToAccount"),
    IDLESESSIONTIMEOUT("idleSessionTimeout"),
    IMPLICIT("implicit"),
    DEFAULTEXPIRATION("defaultExpiration"),
    EXPIRATIONINTERVALOPTIONS("expirationIntervalOptions"),
    PACKAGEMANAGERFOLDER("packageManagerFolder"),
    RESOLVEDHOMEDIRECTORY("resolvedHomeDirectory");
  ...
  public MyselfItem key(KeyEnum key) {
    this.key = key;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    MyselfItem myselfItem = (MyselfItem) o;
    return Objects.equals(this.key, myselfItem.key);
  }
